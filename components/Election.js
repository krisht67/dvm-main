        ...
        <div className="container-main">
          ...
          {!this.state.elStarted & !this.state.elEnded ? (
            <div className="mt-4 text-gray-900">
              <center>
                <div class="bg-white-100 card w-96 shadow-xl outline-dotted outline-gray-900">
                  <div class="card-body">
      ...
      return (
        <div>
          <form onSubmit={handleSubmit(onSubmit)}>
            {!this.state.elStarted & !this.state.elEnded ? (
              <div className="container-main bg-blue-800">
                {/* about-admin */}
                <div className="mockup-code bg-blue-800">
                  <div className="m-2 w-fit rounded-full p-2  hover:underline bg-blue-800">
                    <h2>About Admin</h2>
                  </div>
